...
import com.topzi.chat.adapters.OpponentsFromCallAdapter;
...
public class VideoConversationFragment extends BaseConversationFragment implements Serializable,
    ...
    RecyclerView list_select_users;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dbhelper = DatabaseHandler.getInstance(getContext());
...
//      get opponentVideoTrack - opponent's video track from recyclerView
    ...
    private void userList() {
        ...
        dialog.setContentView(R.layout.dialoge_userlist);
        dialog.getWindow().setBackgroundDrawableResource(android.R.color.white);
        dialog.getWindow().setLayout(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);
        dialog.show();

        list_select_users = dialog.findViewById(R.id.list_select_users);
        List<QBUser> currentOpponentsList = new ArrayList<>();
        contactList.addAll(dbhelper.getStoredContacts(getContext()));
        ...
        if (usersAdapter == null) {
            usersAdapter = new UsersAdapter(getContext(), currentOpponentsList);
            list_select_users.setLayoutManager(new LinearLayoutManager(getContext()));
...
//        private UsersAdapter.SelectedItemsCountChangedListener selectedItemsCountChangedListener;
        ...
        public List<QBUser> getSelectedUsers() {
            return Constants.qbUsersList;
        }

//        public void setSelectedItemsCountsChangedListener(UsersAdapter.SelectedItemsCountChangedListener selectedItemsCountChanged) {
...
//                    selectedItemsCountChangedListener.onCountSelectedItemsChanged(Constants.qbUsersList.size());
    ...
    private void startCall(boolean isVideoCall) {
        Log.d("LLLLLL_Quickbox: ", "Starting Call");

        if (Constants.qbUsersList.size() > Constants.MAX_OPPONENTS_COUNT) {
            ToastUtils.longToast(String.format(getApplicationContext().getString(R.string.error_max_opponents_count),
        ...
        Log.d("LLLLLL_Quickbox: ", "conferenceType = " + conferenceType);

        QBRTCClient qbrtcClient = QBRTCClient.getInstance(getApplicationContext());
        QBRTCSession newQbRtcSession = qbrtcClient.createNewSessionWithOpponents(opponentsList, conferenceType);

        WebRtcSessionManager.getInstance(getApplicationContext()).onReceiveNewSession(newQbRtcSession);

...
public class UiUtils {
    ...
    public static Drawable getGreyCircleDrawable() {
        return getColoredCircleDrawable(ApplicationClass.getInstance().getResources().getColor(R.color.color_grey));
    }
    ...
    public static Drawable getColoredCircleDrawable(@ColorInt int color) {
        GradientDrawable drawable = (GradientDrawable) ApplicationClass.getInstance().getResources().getDrawable(R.drawable.shape_circle);
    ...
    public static int getCircleColor(@IntRange(from = RANDOM_COLOR_START_RANGE, to = RANDOM_COLOR_END_RANGE)
        ...
        int colorId = ApplicationClass.getInstance().getResources()
                .getIdentifier(colorIdName, "color", ApplicationClass.getInstance().getPackageName());

        return ApplicationClass.getInstance().getResources().getColor(colorId);
    }

...
public class ErrorUtils {
    ...
    private static final String NO_CONNECTION_ERROR = ApplicationClass.getInstance().getString(R.string.no_connection_error);
    private static final String NO_RESPONSE_TIMEOUT = ApplicationClass.getInstance().getString(R.string.no_responce_timeout);
    ...
    public static Snackbar showSnackbar(View view, @StringRes int errorMessage, Exception e,
        ...
        if (noConnection || timeout) {
            ...
            return showSnackbar(view, errorMessage, ApplicationClass.getInstance().getString(R.string.no_internet_connection), actionLabel, clickListener);
        } else {
    ...
    public static Snackbar showSnackbar(View view, @StringRes int errorMessage, String error,
                                        @StringRes int actionLabel, View.OnClickListener clickListener) {
        String errorMessageString = ApplicationClass.getInstance().getString(errorMessage);

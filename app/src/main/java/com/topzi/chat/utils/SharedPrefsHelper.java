...
public class SharedPrefsHelper {
    ...
    private SharedPrefsHelper() {
        instance = this;
        sharedPreferences = ApplicationClass.getInstance().getSharedPreferences(SHARED_PREFS_NAME, Context.MODE_PRIVATE);
    }
    ...
    public void saveQbUser(QBUser qbUser) {
        ...
        save(QB_USER_PASSWORD, ApplicationClass.USER_DEFAULT_PASSWORD /*qbUser.getPassword()*/);
